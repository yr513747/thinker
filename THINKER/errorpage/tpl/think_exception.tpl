...
if(!function_exists('parse_file')){
    function parse_file($file, $line)
    {
        ...
        return '<a class="toggle" title="'."{$filestr}第 {$line} 行左右".'">'."{$filestr}第 {$line} 行左右".'</a>';
    }
}
...
<head>
    <meta charset="UTF-8">
    <title><?php echo \think\facade\Lang::get('System Error'); ?></title>
...
<body>
    ...
    <div class="copyright">
        <div id="footer">
    <span>Powered by <a href="<?php echo htmlspecialchars_decode(nl2br(htmlentities($domain))); ?>/" rel="nofollow"><?php echo htmlspecialchars_decode(nl2br(htmlentities($host))); ?></a></span>
  </div>
    </div>
    <?php if (\think\facade\App::isDebug()) { ?>
    <script>
