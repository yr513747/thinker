...
use think\Response;
use think\Route;
use Thinker\route\dispatch\Callback as CallbackDispatch;
use Thinker\route\dispatch\Controller as ControllerDispatch;
use Thinker\route\dispatch\Redirect as RedirectDispatch;
use Thinker\route\dispatch\Response as ResponseDispatch;
use Thinker\route\dispatch\View as ViewDispatch;
...
abstract class Rule 
{
    ...
    protected function dispatchController(Request $request, string $route): ControllerDispatch
    {
        ...
        $multi_app  = config('app.multi_app', false);
		$action     = array_pop($path);
        $controller = !empty($path) ? array_pop($path) : null;
        $app        = $multi_app && !empty($path) ? array_pop($path) : null;
