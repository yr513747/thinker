...
use Thinker\route\Dispatch;
use Thinker\route\dispatch\Url as UrlDispatch;
use Thinker\route\Domain;
use Thinker\route\Resource;
use Thinker\route\Rule;
use Thinker\route\RuleGroup;
use Thinker\route\RuleItem;
use Thinker\route\RuleName;
use Thinker\route\Url as UrlBuild;
use think\Route as BaseRoute;

/**
 * 路由管理类，由于在think\Route的基础上进行了些许修改，需要清空think\Route的所有属性和方法
 * @package think
 */
class Route extends BaseRoute
{
	use traits\route\Reflection;
    /**
     * REST定义
     * @var array
     */
