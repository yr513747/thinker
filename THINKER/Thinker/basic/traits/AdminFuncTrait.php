...
trait AdminFuncTrait
{
     ...
     * @return unknown
     */
    protected final function stripSql($string)
    {
        $pattern_arr = array(
            "/\\bunion\\b/i",
            "/\\bselect\\b/i",
     ...
     */
    protected final function authcode($string, $operation = 'DECODE', $key = '', $expiry = 0)
    {
        $ckey_length = 4;
    ...
    /**
     * 生成UUID
     * UUID的标准格式为“xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxx”
     */
    protected final function uuid()
    {
     ...
     * 屏蔽电话号码中间四位
     */
    protected final function hidtel($phone)
    {
        //固定电话
