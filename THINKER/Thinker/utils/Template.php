...
/**
 * Created by yr.
 * Copyright (c) 2017~2019 http://www.code.com All rights reserved.
...
class Template
{
     ...
     */
    protected $providers = [
        'routine' => \Thinker\services\ProgramTemplateService::class,
        'subscribe' => \Thinker\services\SubscribeTemplateService::class,
        'wechat' => \Thinker\services\WechatTemplateService::class,
    ];
