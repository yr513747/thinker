...
class Cx extends Taglib
{
    ...
    public function tagUrl($tag, $content)
    {
        ...
        $domain = isset($tag['domain']) ? $tag['domain'] : 'true';
        $url_model = isset($tag['url_model']) ? $tag['url_model'] : 'null';
        $url_inlet = isset($tag['url_inlet']) ? $tag['url_inlet'] : 'null';
        return '<?php echo url("' . $url . '","' . $vars . '",' . $suffix . ',' . $domain . ',' . $url_model . ',' . $url_inlet . ');?>';
    }
