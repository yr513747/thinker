...
// +-------------------------------------------------------------------------
// | @license https://github.com/metowolf/Meting Released under the MIT license
// +-------------------------------------------------------------------------
...
class Meting 
{
    ...
    public function search($keyword, $option = null)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'GET',
                'url'    => 'https://gss2.baidu.com/6Ls1aze90MgYm2Gp8IqW0jdnxx1xbK/public/v1/restserver/ting',
                'body'   => array(
                    'from'      => 'qianqianmini',
    ...
    public function album($id)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'POST',
                'url'    => 'http://music.163.com/api/public/v1/album/'.$id,
                'body'   => array(
                    'total'         => 'true',
                    'offset'        => '0',
                    'id'            => $id,
    ...
    public function artist($id, $limit = 50)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'POST',
                'url'    => 'http://music.163.com/api/public/v1/artist/'.$id,
                'body'   => array(
                    'ext'           => 'true',
                    'private_cloud' => 'true',
                    'ext'           => 'true',
    ...
    public function url($id, $br = 320)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'POST',
                'url'    => 'http://media.store.kugou.com/public/v1/get_res_privilege',
                'body'   => json_encode(
                    array(
                    'relate'    => 1,
                    'userid'    => '0',
