...
trait RunTrait
{
    ...
    {
        $this->bind('think\\initializer\\Error', 'Thinker\\Error');
        $this->bind('think\\exception\\Handle', 'Thinker\\ExceptionHandle');
        $this->bind('think\\Http', 'Thinker\\Http');
        $this->bind('think\\Request', 'Thinker\\Request');
        $this->bind('think\\Route', 'Thinker\\Route');
        $this->bind('think\\View', 'Thinker\\View');
		$this->bind('think\\Paginator', 'Thinker\\Bootstrap');
