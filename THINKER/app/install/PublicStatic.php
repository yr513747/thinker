...
class PublicStatic
{
    ...
    protected function init()
    {
        ...
        $basePath = str_replace($depr, DS, ltrim(rtrim($url, $filename), $depr . ''));
		
        $basePath = $this->app->getBasePath() . 'install' . DS . 'static' . DS . $basePath;
    ...
    public function index($path = NULL)
    {
        ...
        $extlayer = trim(strrchr($filename, DS), DS);
