...
use Thinker\template\taglib\Thinker;
...
class Channeltype extends Base
{
    ...
    public function _initialize() {
        parent::_initialize();
        $thinker = new Thinker('');
        $this->channeltype_system_nid = array_merge($this->channeltype_system_nid, array_keys($thinker->getTags()));
...
<section class="article-list">
                    {list pagesize="10" titlelen="38"}
                    <article>
                        {notempty name="\$field.is_litpic"}
...
<section class="article-list">
                    ...
                    <article>
                        ...
                        <div class="meta">
                            <span class="item"><time>{\$field.add_time|MyDate='Y-m-d',###}</time></span>
                            <span class="item">{\$field.typename}</span>
                            {arcview aid='\$field.aid' id='view'}
                                  {volist name="\$view.file_list" id='vo'}
                                ...
                                <div class="pic">
                                    <div class="wrap">
                                        {volist name="\$thinker.field.image_list"}
                                            <img src="{\$field.image_url}" alt="{\$thinker.field.title}" />
                                        {/volist}
                                    </div>
                                </div> 
                            </fieldset>
...
<div class="md_block">
                            <fieldset>
                                <legend>下载地址：</legend>
                                 {volist name="\$thinker.field.file_list" id="field"}
