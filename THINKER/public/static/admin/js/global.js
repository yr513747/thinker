...
var tp_unknown_error = '未知错误，无法继续！';
...
{       
    var upurl = thinker_basefile + '?' + var_app + '='+app_name+'&' + var_controller + '=Uploadify&' + var_action + '=upload_product&aid='+id+'&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
    layer.open({
        type: 2,
        title: '上传图片',
        shadeClose: true,
...
//在iframe内打开易优官网的页面
function click_to_thinker_1575506523(url,title) {
    //iframe窗
    layer.open({
        type: 2,
        title: title,
