...
function openItem(param) {
    ...
    //var src = thinker_basefile + '?' + var_app + '=' + app_name + '&' + var_controller + '=' + data_str[0] + '&' + var_action + '=' + data_str[1];
	var src = thinker_basefile + var_depr + app_name + var_depr + data_str[0] + var_depr + data_str[1];
    ...
    $.cookie('workspaceParam', data_str[1] + '|' + data_str[0], {
        expires: 1,
        path: "/"
    });
