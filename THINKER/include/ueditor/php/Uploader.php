...
class Uploader
{
    ...
    public function __construct($fileField, $config, $type = "upload")
    {
        ...
        $encode = mb_detect_encoding($this->stateMap['ERROR_TYPE_NOT_ALLOWED'], array("ASCII",'UNICODE','UTF-8',"GB2312","GBK",'BIG5')); 
        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = mb_convert_encoding($this->stateMap['ERROR_TYPE_NOT_ALLOWED'], 'UTF-8', $encode);
    }
    ...
    {
        $file = $this->file = isset($_FILES[$this->fileField]) ? $_FILES[$this->fileField] : [];
    ...
    private function upBase64()
    {
		...
		$base64Data = input('param.{$this->fileField}', '', null);
    ...
    private function  checkSize()
    {
		...
		$maxFileupload = unformat_bytes($maxFileupload) - 48576;
        return $this->fileSize <= ($this->config["maxSize"]) && $this->fileSize <= $maxFileupload ? TRUE : FALSE;;
    }
