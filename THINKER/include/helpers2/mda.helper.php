...
define('MDA_API_BIND_USER', MDA_APIHOST.'/api_v1/thinker/bind_user');
define('MDA_API_LOGIN', MDA_APIHOST.'/api_v1/thinker/login');
define('MDA_API_CHECK_LOGIN', MDA_APIHOST.'/api_v1/thinker/check_login');
define('MDA_API_GET_PLACE', MDA_APIHOST.'/api_v1/thinker/get_place');
