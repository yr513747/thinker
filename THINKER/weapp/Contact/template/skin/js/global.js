...
{   
        ...
        $.ajax({
            type:'POST',
            url: thinker_basefile + "?"+var_app+"="+app_name+"&"+var_controller+"=Index&"+var_action+"=changeTableVal&table="+table+"&id_name="+id_name+"&id_value="+id_value+"&field="+field+'&value='+value,         
            success: function(data){
