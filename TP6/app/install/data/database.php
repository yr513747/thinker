...
return [
    ...
    // mysql的sql-mode模式参数
    'system_sql_mode' => env('database.sqlmode', '#SQL_MODE#'),
    // 数据库连接配置信息
    'connections'     => [
        'mysql' => [
            // 数据库类型
            'type'              => env('database.type', '#DB_TYPE#'),
            // 服务器地址
            ...
            // 数据库编码默认采用utf8mb4
            'charset'           => env('database.charset', '#DB_CHARSET#'),
            // 数据库表前缀
            'prefix'            => env('database.prefix', '#DB_PREFIX#'),
