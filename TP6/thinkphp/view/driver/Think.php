    ...
    private function parseTemplate(string $template): string
    {
        ...
        if (0 !== strpos($template, '/')) {
            ...
            if (strpos($controller, '.')) {
                ...
                $controller = substr($controller, 0, $pos) . '.' . self::parseName(substr($controller, $pos + 1));
            } else {
                $controller = self::parseName($controller);
            }
            ...
            if ($controller) {
                if ('' == $template) {
                    ...
                    if (2 == $this->config['auto_rule']) {
                        ...
                        $template = self::parseName($request->action());
                    }
        ...
        return $path . ltrim($template, $depr) . '.' . ltrim($this->config['view_suffix'], '.'); 
    }
